...
<head>
    ...
    <title>Login Siswa | Suara Sekolah</title>
...
<div class="login-shell">
    <div class="login-side">
        ...
        <h1>Masuk dengan nomor handphone.</h1>

        <p class="welcome-copy">
            Gunakan akun siswa Anda untuk mengakses portal, melihat status laporan, dan tetap terhubung dengan informasi penting dari sekolah.
        </p>

        <div class="check-list">
            <div class="check-item">Login cepat dengan nomor handphone</div>
            <div class="check-item">Akses laporan secara langsung</div>
            <div class="check-item">Fitur aman untuk data siswa</div>
        </div>
    </div>
    ...
    <div class="login-form-wrap">
        <div class="login-card">
            <div class="login-header">
                <div class="login-pill">Portal siswa</div>
                <h2>Login Siswa</h2>
            </div>
            ...
            <div class="switch-link">
                Belum punya akun? <a href="{{ route('student.register') }}">Daftar siswa</a>
            </div>
            <div class="switch-link">
                Admin login? <a href="{{ route('admin.login') }}">Klik di sini</a>
            </div>
        </div>
    </div>
</div>
