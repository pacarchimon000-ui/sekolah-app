...
<head>
    ...
    <title>Daftar Siswa | Suara Sekolah</title>
...
<div class="login-shell">
    <div class="login-side">
        ...
        <p class="welcome-copy">
            Daftarkan diri Anda untuk mulai mengirim laporan, memantau status, dan melihat riwayat aspirasi serta pengaduan Anda.
        </p>

        <div class="check-list">
            <div class="check-item">Akses cepat dengan nomor handphone</div>
            <div class="check-item">Pantau laporan secara langsung</div>
            <div class="check-item">Terhubung dengan sekolah lebih mudah</div>
        </div>
    </div>
    ...
    <div class="login-form-wrap">
        <div class="login-card">
            <div class="login-header">
                <div class="login-pill">Daftar siswa</div>
            ...
            <div class="switch-link">
                Sudah punya akun? <a href="{{ route('student.login') }}">Login siswa</a>
            </div>
        </div>
    </div>
</div>
