...
<head>
    ...
    <title>Daftar Admin | Suara Sekolah</title>
...
<div class="login-shell">
    <div class="login-side">
        ...
        <p class="eyebrow">daftar admin</p>
        <h1>Buat akun admin baru.</h1>

        <p class="welcome-copy">
            Daftarkan admin baru untuk mengelola laporan, melihat detail pelapor, dan melakukan update status secara cepat.
        </p>

        <div class="check-list">
            <div class="check-item">Pantau laporan real time</div>
            <div class="check-item">Kelola status dan tindak lanjut</div>
            <div class="check-item">Hubungi siswa via WhatsApp</div>
        </div>
    </div>
    ...
    <div class="login-form-wrap">
        <div class="login-card">
            <div class="login-header">
                <div class="login-pill">Daftar admin</div>
            ...
            <div class="switch-link">
                Sudah punya akun? <a href="{{ route('admin.login') }}">Login admin</a>
            </div>
        </div>
    </div>
</div>
